            ...
            <section className="space-y-6">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    ...
                    >
                        ...
                        <h4 className="title-contrast mt-5 text-lg font-semibold">{t("dashboard.captionGenerator","Générer des Captions")}</h4>
                        <p className="mt-2 text-sm leading-6 text-slate-500 dark:text-zinc-400">{t("dashboard.captionGeneratorSubtitle","Upload une video, choisis la plateforme cible, ajuste les captions puis rends la version finale.")}</p>
                    </button>
                </div>
            </section>
