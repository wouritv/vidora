export const FONT_OPTIONS = [
    // 🔥 TikTok / Viral
    { value: 'Bebas Neue', label: 'Bebas Neue', category: '🔥 TikTok / Viral' },
    { value: 'Anton', label: 'Anton', category: '🔥 TikTok / Viral' },
    { value: 'Impact', label: 'Impact', category: '🔥 TikTok / Viral' },
    { value: 'Bangers', label: 'Bangers', category: '🔥 TikTok / Viral' },
    { value: 'Archivo Black', label: 'Archivo Black', category: '🔥 TikTok / Viral' },
    ...
    { value: 'Righteous', label: 'Righteous', category: '🎉 Fun & Playful' },
    { value: 'Boogaloo', label: 'Boogaloo', category: '🎉 Fun & Playful' },
    { value: 'Luckiest Guy', label: 'Luckiest Guy', category: '🎉 Fun & Playful' },
    { value: 'Baloo 2', label: 'Baloo 2', category: '🎉 Fun & Playful' },
...
export const ANIMATION_OPTIONS = [
    { value: 'pop', label: 'Pop', desc: 'Le mot actif grossit avec un effet ressort' },
