...
const ISSUES_URL = 'https://github.com/mutonby/Vireel/issues';
        ...
        <div className="min-h-screen bg-bg text-white">
            ...
            <main className="max-w-3xl mx-auto px-6 py-12">
                ...
                <Section title="The short version">
                    <p>
                        Vireel is a free, open-source AI clip generator. There are no accounts, no payments, and we
                ...
                <Section title="You are responsible for what you upload">
                    ...
                    <p>
                        ...
                        agree to indemnify Vireel and its contributors against any third-party claim arising from
                ...
                <Section title="Self-hosted instances">
                    <p>
                        Vireel is open source and may be self-hosted. This notice applies only to the hosted
